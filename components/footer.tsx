      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-5 flex flex-col sm:flex-row justify-between items-center gap-3">
          ...
          <div className="flex gap-5">
            <Link href="/docs#privacy" className="text-xs text-default-400 hover:text-primary transition-colors">
              Privacy Policy
            </Link>
            <Link href="/docs#terms" className="text-xs text-default-400 hover:text-primary transition-colors">
              Terms of Service
            </Link>
          </div>
        </div>
